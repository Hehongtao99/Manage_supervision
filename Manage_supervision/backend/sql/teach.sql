...
CREATE TABLE `orders`  (
  ...
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'PENDING' COMMENT '订单状态：PENDING(待确认), ACCEPTED(已接受), REJECTED(已拒绝), CANCELED(已取消), COMPLETED(已完成), REFUND_PENDING(退款申请中), REFUND_REJECTED(退款申请被拒), APPEALING(申诉中), APPEAL_APPROVED(申诉通过), APPEAL_REJECTED(申诉驳回)',
  ...
  `teacher_response` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '教师回复',
  `admin_decision` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '管理员决定',
